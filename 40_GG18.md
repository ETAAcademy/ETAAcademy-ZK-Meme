...
### Distributed Key: Secret Sharing Protocol + zk Zero-Knowledge Proof
...
- $k*1 \gamma_2 = \alpha*{1,2} + \beta\_{2,1}$
- $k*1 \gamma_3 = \alpha*{1,3} + \beta\_{3,1}$
- $k*2 \gamma_1 = \alpha*{2,1} + \beta\_{1,2}$
- $k*2 \gamma_3 = \alpha*{2,3} + \beta\_{3,2}$
- $k*3 \gamma_1 = \alpha*{3,1} + \beta\_{1,3}$
- $k*3 \gamma_2 = \alpha*{3,2} + \beta\_{2,3}$

Similarly, to compute $s$, six more MtA share conversion protocols are necessary:

- $k*1 w_2 = u*{1,2} + v\_{2,1}$
- $k*1 w_3 = u*{1,3} + v\_{3,1}$
- $k*2 w_1 = u*{2,1} + v\_{1,2}$
- $k*2 w_3 = u*{2,3} + v\_{3,2}$
- $k*3 w_1 = u*{3,1} + v\_{1,3}$
- $k*3 w_2 = u*{3,2} + v\_{2,3}$

$R = k^{-1} \cdot G \\ = (kγ)^{-1}\cdot(γ\cdot G) \\ = ((k*1+k_2+k_3)(γ_1+γ_2+γ_3))^{-1}\cdot (γ_1+γ_2+γ_3)\cdot G \\ = \begin{pmatrix}
...
k_1γ_1 +(α*{1,2} + β*{2,1} ) + (α*{1,3} + β*{3,1} ) +\\
(α*{2,1} + β*{1,2} ) +k_2γ_2 + (α*{2,3} + β*{3,2} ) +\$α*{3,1} + β*{1,3} ) + (α*{3,2} + β\_{2,3} )+ k_3γ_3

\end{pmatrix}^{-1}\cdot (Γ*1+Γ_2+Γ_3)\\ = \begin{pmatrix}
k_1γ_1 + α*{1,2} + α*{1,3} + β*{1,2} + β*{1,3} +\\
k_2γ_2 + α*{2,1}+ α*{2,3} + β*{2,1} + β*{2,3} +\\
k_3γ_3 +α*{3,1} +α*{3,2} +β*{3,1} + β\_{3,2}
...
$s = k(m +xr) \\ = mk + rkx \\ = m(k*1+k_2+k_3) + r(k_1 + k_2 + k_3)(w_1+w_2+w_3) \\ = m(k_1+k_2+k_3)+r\begin{pmatrix}
k_1w_1 +(k_1w_2) + (k_1w_3) +\\
(k_2w_1) +k_2w_2 + (k_2w_3) +\\
(k_3w_1) +(k_3w_2) + k_3w_3
\end{pmatrix} \\ = m(k_1+k_2+k_3) + r\begin{pmatrix}
k_1γ_1 +(u*{1,2} + v*{2,1} ) + (u*{1,3} + v*{3,1} ) +\\
(u*{2,1} + v*{1,2} ) +k_2γ_2 + (u*{2,3} + v*{3,2} ) +\$u*{3,1} + v*{1,3} ) + (u*{3,2} + v\_{2,3} )+ k_3γ_3

\end{pmatrix}\\ = m(k*1+k_2+k_3) + r\begin{pmatrix}
k_1γ_1 + u*{1,2} + u*{1,3} + v*{1,2} + v*{1,3} +\\
k_2γ_2 + u*{2,1}+ u*{2,3} + v*{2,1} + v*{2,3} +\\
k_3γ_3 +u*{3,1} +u*{3,2} +v*{3,1} + v\_{3,2}
