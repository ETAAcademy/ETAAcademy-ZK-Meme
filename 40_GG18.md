...
$s = k(m +xr) \\ = mk + rkx \\ = m(k_1+k_2+k_3) + r(k_1 + k_2 + k_3)(w_1+w_2+w_3) \\ = m(k_1+k_2+k_3)+r(
k_1w_1 +(k_1w_2) + (k_1w_3) +
(k_2w_1) +k_2w_2 + (k_2w_3) +
(k_3w_1) +(k_3w_2) + k_3w_3) \\ = m(k_1+k_2+k_3) + r(k_1γ_1 +(u_{1,2} + v_{2,1} ) + (u_{1,3} + v_{3,1} ) +\\
(u_{2,1} + v_{1,2} ) +k_2γ_2 + (u_{2,3} + v_{3,2} ) + u_{3,1} + v_{1,3} ) + (u_{3,2} + v\_{2,3} )+ k_3γ_3)\\ = m(k_1+k_2+k_3) + r(k_1γ_1 + u_{1,2} + u_{1,3} + v_{1,2} + v_{1,3} +
k_2γ_2 + u_{2,1}+ u_{2,3} + v_{2,1} + v_{2,3} +
k_3γ_3 +u_{3,1} +u_{3,2} +v_{3,1} + v\_{3,2})\\=m(k_1 + k_2 +k_3)+ r(σ_1 + σ_2 + σ_3)^{-1}\\=(mk_1 + rσ_1)+(mk_2+rσ_2)+(mk_3+rσ_3)\\=s_1+s_2+s_3$
